...
chord = x_Lower + 3/4*chordLength; %location of chord above the y-axis 
...
for n = 1: points
    ...
    x_Upper_Rotated(n) = transformed(1,1)- skewDistance(n); % adding skew
    x_Lower_Rotated(n) = transformed(1,2)- skewDistance(n);
...
twisted_Upper = vertcat(x_Upper_Rotated,y+40, z_Rotated_Upper); 
twisted_Lower = vertcat(x_Lower_Rotated,y+40,z_Rotated_Lower);
